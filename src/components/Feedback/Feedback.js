...
import {FeedbackSection, FeedbackWrapper, FeedbackHeading, FeedbackText,ImageContainer,Image,ImageFeedbackWait,SecondText,Subtitle,Text,SecondColumn, ObjectMain} from './Feedback.elements'
